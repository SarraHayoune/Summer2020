# Assignement: Ruth simulation (h148)[focusing on galaxy merger 
import pynbody 
import numpy as np
...
files = readcol.readcol('/media/jillian/h148/files.list')
files = files[:,0]
...
for j in range (4,15):
    ...
    s =pynbody.load('/media/jillian/h148/'+files[j])
        ...
        if len(BH)== 2:
            ...
            if  BHhalos[0]  ==  BHhalos[1]:
               ...
               # print "y position", BHy
                ...
                BHF.render(s,width= '15 kpc',plot= True, ret_im= True)
